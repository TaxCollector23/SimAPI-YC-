...
const items: Item[] = [
  { status: "shipped", title: "470+ deterministic physics checks across 21 domains", detail: "core/physics_validator.py — the full engine, available locally or via a self-hosted Python backend." },
  ...
  { status: "in-progress", title: "Hybrid TypeScript/Python engine on the deployed site", detail: "The live site runs a ~20-check TypeScript engine by default; setting PYTHON_API_URL upgrades it to the full 470+ check engine. The engine badge in the dashboard tells you which one you're getting." },
